...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="plugins/images/headerIcon.png">
    <title>Tea SupplyChain</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div >
                    <div class="form-group text-center">
                        <div class="col-xs-12">
                             ...
                             <img src="plugins/images/teaLogo1.jpg" style="width: 225px; height: 225px;" />
                             <!-- <img src="plugins/images/teaLogo2.jpg" style="width: 225px; height: 225px;" /> -->
                    ...
                    <div class="form-group text-center">
                        ...
                        <div class="col-xs-6 p-b-20">
                            <a href="admin.php" class="btn btn-rounded btn-block btn-primary">Admin Log In</a>
                        </div>
                    </div>   
            </div>
        </div>
